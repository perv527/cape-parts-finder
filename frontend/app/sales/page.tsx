                    ...
                    <div className="px-4 pb-4">
                      ...
                      <div className="rounded-lg p-3 mt-1" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <button onClick={() => printSaleInvoice(sale)}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-medium cursor-pointer transition mb-2 w-full justify-center"
