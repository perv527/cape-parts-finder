                ...
                <div className="p-5">
                  ...
                  <div className="mt-5 flex flex-wrap gap-2.5">
                    ...
                    <button onClick={() => setTemplateModal(request)}
                      ...
                      <button onClick={() => window.open("https://wa.me/" + request.phone_number.replace(/\D/g, ""))} className="flex items-center gap-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 px-5 py-2.5 rounded-xl text-[13px] font-medium transition cursor-pointer">
