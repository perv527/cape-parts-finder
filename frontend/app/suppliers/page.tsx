    ...
    <main style={darkBg}>
        ...
        <header style={{ borderBottom: "1px solid rgba(255,255,255,0.06)", backdropFilter: "blur(12px)", background: "rgba(17,17,17,0.85)", position: "sticky", top: 0, zIndex: 50 }}>
          <div className="max-w-7xl mx-auto px-5 h-14 flex items-center justify-between">
            ...
            <div className="flex gap-1">
              {[{ label: "Requests", href: "/admin" }, { label: "Suppliers", href: "/suppliers", active: true }, { label: "Sales", href: "/sales" }, { label: "Inventory", href: "/inventory" }, { label: "Expenses", href: "/expenses" }, { label: "Analytics", href: "/analytics" }].map((n) => (
            ...
            {filteredSuppliers.map((supplier) => {
              ...
              return (
                <div key={supplier.id} className="rounded-2xl overflow-hidden transition" style={{ ...cardStyle, border: requestId ? "1px solid rgba(249,115,22,0.15)" : "1px solid rgba(255,255,255,0.07)" }}>
                  ...
                  <button onClick={e => { e.stopPropagation(); setRatingModal(supplier); setRatingNote(""); }}
      ...
      {ratingModal && (
        <div className="fixed inset-0 flex items-end sm:items-center justify-center" style={{ background: "rgba(0,0,0,0.75)", zIndex: 100, backdropFilter: "blur(4px)", padding: "0" }}>
          <div className="w-full sm:max-w-sm sm:mx-4 rounded-t-2xl sm:rounded-2xl overflow-hidden" style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.1)" }}>
      ...
      {quoteModal && (
        <div className="fixed inset-0 flex items-end sm:items-center justify-center" style={{ background: "rgba(0,0,0,0.75)", zIndex: 100, backdropFilter: "blur(4px)" }}>
          <div className="w-full sm:max-w-md sm:mx-4 rounded-t-2xl sm:rounded-2xl overflow-hidden" style={{ background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.1)", width: "100%", maxWidth: "100%", boxSizing: "border-box", overflowX: "hidden" as const, position: "relative" }}>
            <div className="p-5 flex items-center justify-between" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
              <div>
            ...
            <div style={{ padding: "16px", overflowX: "hidden" as const, boxSizing: "border-box", width: "100%", maxWidth: "100%" }}>
              {quoteSuccess ? (
                <div className="text-center py-6">
...
export default function SuppliersPage() {
  return (
    <Suspense fallback={
      <main style={{ background: "#111111", minHeight: "100vh", overflowX: "hidden" as const, }} className="flex items-center justify-center">
        <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
      </main>
    }>
      <SuppliersContent />
